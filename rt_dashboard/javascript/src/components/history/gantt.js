...
export default function ganttOuter(ganttConfig) {
  ...
  if (ganttConfig != null) {
    ...
    var y = scaleBand().domain(eventTypes).rangeRound([0, height - margin.top - margin.bottom], .1);
...
//--------------------------------------------------------------------------------------------------------------------------
  ...
  var initAxis = function () {
    ...
    y = scaleBand().domain(eventTypes).rangeRound([0, (height) - margin.top - margin.bottom], .2);
